...
export function getAllBook(http: HttpClient, rootUrl: string, params?: GetAllBook$Params, context?: HttpContext): Observable<StrictHttpResponse<PageResponseBookResponse>> {
